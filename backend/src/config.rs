...
pub struct Settings {
    ...
    pub enable_phase1_whale_ride: bool,
    pub enable_phase2_snipe: bool,
    pub phase1_cooldown_ms: i64,
    ...
    pub snipe_min_price_delta_pct: f64,
...
impl Settings {
    pub fn from_env() -> Result<Self> {
        Ok(Self {
            ...
            maker_order_ttl_ms: env_parse("MAKER_ORDER_TTL_MS", 300_000)?,
            ...
            max_position_usd: env_parse("MAX_POSITION_USD", 1.0)?,
            ...
            enable_phase1_whale_ride: env_bool("ENABLE_PHASE1_WHALE_RIDE", true),
            enable_phase2_snipe: env_bool("ENABLE_PHASE2_SNIPE", true),
            phase1_cooldown_ms: env_parse("PHASE1_COOLDOWN_MS", 15_000)?,
            ...
            snipe_max_position_usd: env_parse("SNIPE_MAX_POSITION_USD", 1.0)?,
            snipe_max_signals: env_parse("SNIPE_MAX_SIGNALS", 8)?,
            snipe_min_price_delta_pct: env_parse("SNIPE_MIN_PRICE_DELTA_PCT", 0.0005)?,
            active_symbols: parse_symbols(&env_string("ACTIVE_SYMBOLS", "")),
            ...
            live_max_order_usd: env_parse("LIVE_MAX_ORDER_USD", 1.0)?,
